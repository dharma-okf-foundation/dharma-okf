"""Regression test: the dharmic-ethics bundle must stay conformant (OKF v0.2).

Runs the OKF validator over okf/dharmic-ethics and asserts zero FAIL-level
...
BUNDLE = OKF_ROOT / "dharmic-ethics"
...
def test_bundle_exists():
    ...
    assert len(concepts) == 15, f"expected 15 concepts, found {len(concepts)}"
