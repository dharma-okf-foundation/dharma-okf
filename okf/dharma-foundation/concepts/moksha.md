...
**Liberation is available at any time** — not only after death. The Bhagavad Gītā states: one who departs the body while chanting Om becomes liberated, independent of any intermediary. Multiple valid paths lead there.
...
**"Salvation"** implies rescue by an external savior from a fallen state (Original Sin). In the Vedāntic framework, you are not fallen — you are Brahman appearing to be limited. No one saves you; you wake up. The jīva's bondage is beginningless, not caused by transgression.

**"Heaven"** is a temporary destination in a reward-punishment schema. Even *Svarga* (the closest to "heaven") is temporary — beings exhaust their merit and return to earth. Mokṣa is beyond all *lokas* and entirely permanent.

**"Kaivalya"** specifically — Kaivalya is one *type* of mokṣa (the Sāṃkhya/Yoga term for isolation from Prakṛti and the Advaita term for merger into Brahman), not a synonym for liberation as a whole.
