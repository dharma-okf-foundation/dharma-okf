...
Karma is NOT sin. Sin in Abrahamic theology is a moral offense against God requiring divine forgiveness. Karma is cause-and-effect — no offense, no judge, no forgiveness needed. A burnt hand is not "punished" by the fire; it encountered a natural consequence. Karma operates the same way at the moral-experiential level.

## Why the Substitutes Fail

**"Fate"** implies predetermination with no agency. Karma explicitly preserves free will — *Prārabdha* shapes the field, but *Kriyamāna* (your current actions) shapes the future. You are never "fated."

**"What goes around comes around"** trivializes a precise multi-life mechanism into a bumper sticker. It also implies same-life return, which karma does not require — consequences may ripen across many lifetimes.
